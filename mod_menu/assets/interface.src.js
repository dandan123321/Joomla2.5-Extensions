...
jQuery.iFisheye = {
    build: function (options) {
        return this.each(function () {
            ...
            el.fisheyeCfg = {
                ...
                space: options.space ? options.space : 0,
            ...
            function (e) {
                ...
                el.fisheyeCfg.items.each(function (nr) {
                    distance = Math.sqrt(Math.pow(posx - nr * (el.fisheyeCfg.itemWidth + el.fisheyeCfg.space), 2) + posy);
                    ...
                    this.style.left = (el.fisheyeCfg.itemWidth + el.fisheyeCfg.space) * nr + toAdd + 'px';
                    toAdd += extraWidth
                });
    ...
    positionContainer: function (el, toAdd) {
        if (el.fisheyeCfg.halign) if (el.fisheyeCfg.halign == 'center') el.fisheyeCfg.container.get(0).style.left = (el.offsetWidth - (el.fisheyeCfg.itemWidth + el.fisheyeCfg.space) * el.fisheyeCfg.items.size()) / 2 - toAdd / 2 + 'px';
